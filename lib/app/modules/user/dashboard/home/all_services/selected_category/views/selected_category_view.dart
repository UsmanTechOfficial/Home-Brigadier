...
import '../category_item/house_cleaning/views/deep_cleaning_view.dart';
import '../category_item/house_cleaning/views/sofa_cleaning.dart';
        ...
        onPressed: () {
          ...
          switch (model.category!.code) {
            ...
            case 'sofaCleaning':
              ...
              BookingController.to.hours.value = 1;
              BookingController.to.claculateBill();
              Get.to(() => const SofaCleaningBookingView());
              break;
            case 'electricity':
              BookingController.to.setServicesModel(model);
              BookingController.to.selectMaterials("No");
            ...
            case 'deepCleaning':
              ...
              BookingController.to.hours.value = 1;
              BookingController.to.claculateBill();
              Get.to(() => const DeepCleaningBookingView());
              break;
            case 'plumbing':
              BookingController.to.setServicesModel(model);
              BookingController.to.selectMaterials("No");
