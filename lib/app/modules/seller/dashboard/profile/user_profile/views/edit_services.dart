            ...
            IconButton(
                ...
                onPressed: () {
                  showConfirmationBottomSheet(
                      GlobalVariable.serviceModel.id, controller, context);
                },
                icon: Icon(
...
void showConfirmationBottomSheet(
    id, UserProfileController controller, context) {
  Get.bottomSheet(
    Container(
            ...
            children: [
              ElevatedButton(
                ...
                child: Padding(
                  ...
                  child: Text(
                    LocaleKeys.house_cleaning_items_no.tr,
              ...
              ElevatedButton(
                onPressed: () async {
                  Get.back();
                  controller.deleteServices(id: id, context: context);
                },
                style: ElevatedButton.styleFrom(
                ...
                child: Padding(
                  ...
                  const EdgeInsets.symmetric(vertical: 12, horizontal: 20),
                  child: Text(
                    LocaleKeys.house_cleaning_items_yes.tr,
                    style: const TextStyle(fontSize: 18),
                  ),
                ),
              )
