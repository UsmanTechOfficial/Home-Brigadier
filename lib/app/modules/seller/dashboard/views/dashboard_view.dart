...
class SellerDashboardView extends GetView<SellerDashboardController> {
  ...
  Widget build(BuildContext context) {
    print("Now Access token is ${StaticData.accessToken}");
    ...
    return GetBuilder<SellerDashboardController>(
        ...
        builder: (builderContext) {
          return PopScope(
            ...
            onPopInvoked: (didPop) {
              if (!didPop) {
                if (JobsController.to.tabController.index == 1) {
                  JobsController.to.tabController.animateTo(0);
                } else {
                ...
                return BottomNavigationBar(
                  ...
                  items: [
                    ...
                    BottomNavigationBarItem(
                      ...
                      label: GlobalVariable.label.value.tr,
                    ),
                    BottomNavigationBarItem(
                      icon: Padding(
                        padding: const EdgeInsets.only(bottom: 6),
